...
browser.get('https://sudoku.com/easy/')

game_row_list = browser.find_elements_by_class_name('game-row')


print('game row list length:')
print(len(game_row_list))
...
for row in game_row_list:
    ...
    for cell in row_cell_values:
        try:
            ...
            game_string += values[square_value.get_attribute('d')]
...
# if(svgs[0].get_attribute('d') == one): print(1)
# if(svgs[0].get_attribute('d') == two): print(2)
# if(svgs[0].get_attribute('d') == three): print(3)
# if(svgs[0].get_attribute('d') == four): print(4)
# if(svgs[0].get_attribute('d') == five): print(5)
# if(svgs[0].get_attribute('d') == six): print(6)
# if(svgs[0].get_attribute('d') == seven): print(7)
# if(svgs[0].get_attribute('d') == eight): print(8)
# if(svgs[0].get_attribute('d') == nine): print(9)

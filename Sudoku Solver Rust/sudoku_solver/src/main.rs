...
const DEEP_SOLVE_TEST_2: &'static str = "";
const DEEP_SOLVE_TEST_3: &'static str = "";
...
fn main() {
    let mut curr_board = 
        ...
        Board::from_list(
            ...
            String::from("040080020,600004801,000605400,300,080000342,904200600,060009704,000076") //deep check test
